...
from llm.local import OllamaClient, OllamaConfig
...
class TestOllamaConfig:
    ...
    def test_environment_variable_config(self):
        ...
        }), patch('llm.local.get_rag_config') as mock_get_config:
            # Mock the config to return a specific model name
            mock_config = MagicMock()
            mock_config.model_name = "env-model:test"
...
class TestOllamaClient:
    ...
    def _create_mocked_client(self, health_check_return=True):
        ...
        with patch('llm.local.OllamaClient._check_ollama_health', return_value=health_check_return):
            return OllamaClient()
    
    def test_init_default_config(self):
        """Test initialization with default config"""
        with patch('llm.local.OllamaClient._check_ollama_health', return_value=True):
            client = OllamaClient()
    ...
    def test_init_ollama_not_running(self):
        ...
        with patch('llm.local.OllamaClient._check_ollama_health', return_value=False):
    ...
    async def test_context_manager(self):
        ...
        with patch('httpx.AsyncClient') as mock_client_class, \
             patch('llm.local.OllamaClient._check_ollama_health', return_value=True):
